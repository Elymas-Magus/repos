...
class Menu:
    ...
    def getMenu(self):
        ...
        btn = Button(self.menu, text = "Converter", command=lambda: self.exec_btn_click(label_page, 'Converter'))
        btn.pack()
        
        btn = Button(self.menu, text = "Criar", command=lambda: self.exec_btn_click(label_page, 'Converter'))
        btn.pack()
