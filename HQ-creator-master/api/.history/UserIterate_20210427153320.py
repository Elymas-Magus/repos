...
class userInput:
    ...
    def menu(self):
        ...
        p_x = (self.screensize['width'] - self.windowsize['width'])/2
        p_y = (self.screensize['height'] - self.windowsize['height'])/2
        
        menu.geometry(f"{self.windowsize['width']}x{self.windowsize['height']}+{}+{self.screensize['height']}")
        menu.mainloop()
