...
class userInput:
    ...
    def menu(self):
        ...
        self.window = sg.Window(self.title, size=(500, 250)).layout(self.layout)
        ...
        while True:
            ...
            if self.button == 'multi_files':
                ...
                self.inputContent = {'type': 'multi', 'path': filename, 'closed': False, 'sub': self.values['sub_files']}
                ...
                self.inputContent = {'type': 'all', 'path': dirpath, 'closed': False, 'sub': self.values['sub_files']}
    ...
    def getLayout(self):
        return [
            ...
            [sg.Button("Iniciar", size=(60, 2), key="img_files")],
        ]
